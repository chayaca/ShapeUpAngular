...
export class ProjectDetailsComponent implements OnInit {
  ...
  public pr:Projects= new Projects();
...
this.p=this.ShapesService.currentProject;
  ...
  olddrawing(projectName: string, orderDate: Date, dueDate: Date, projectStatus:boolean) {
    this.pr.projectName = projectName;
    this.pr.orderDate = orderDate;
    this.pr.dueDate = dueDate;
    this.pr.id=this.ShapesService.currentProject.id;
    this.pr.projectStatus=projectStatus;
  ...
  DeleteProject() {
    this.ShapesService.DeleteProject().subscribe();
    this.ngOnInit();
  }
}
